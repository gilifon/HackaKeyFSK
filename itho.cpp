...
void Itho::sendCommand(byte* data, int length, int repetitions) {

  setupRF();
  cc1150.sendSerialData(data, length, itho_RF_Delay, repetitions );
  resetGDO();
...
void Itho::setupRF() {
  ...
  cc1150.writeRegister(CC1150_MDMCFG4 , ITHO_RF_MDMCFG4); //0x10 0x08
  cc1150.writeRegister(CC1150_MDMCFG3 , ITHO_RF_MDMCFG3); //0x11 0x43
  cc1150.writeRegister(CC1150_DEVIATN, ITHO_RF_DEVIATN); //0x15 0x40
